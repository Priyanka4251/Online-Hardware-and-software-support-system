...
public class MainUseCase {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			System.out.println("Welcome to LLD of Software and Hardware Online System Design by Priyanka Dhar ");
...
//								    if(hod.equalsIgnoreCase("done")) {
									...
									System.out.println("1.Appoint a new Engineer... ");
									System.out.println("2.See All engineers working in department.... ");
									System.out.println("3.terminate engineer from work.... ");
									    	...
									    	while(true) {
									        	...
									        	try {
									        		List<Engineer> engineers= deo.getEngineersDetail();
									        			...
									        			System.out.println("Engineer password is:"+e.getEngPass());
			    ...
			    case 2:
			        {
			    		...
			    		try {
			    			Engineer engineer= dao.loginEngineer(EngUserName, EngPass);
...
//											System.out.println("Problem status is : "+e.getPstatus());
							    ...
							    case 2:{
							    	...
							    	while(true) {
							    	 System.out.println("Please enter your pid to update status");
										int prid = sc.nextInt();
