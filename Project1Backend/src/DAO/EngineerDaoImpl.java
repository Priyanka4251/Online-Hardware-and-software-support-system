...
//================================================================================================//	
	...
	PreparedStatement ps=conn.prepareStatement("insert into Engineer(EngName,EngUserName,EngPass,EngCategory) values(?,?,?,?)");
...
//==================================================================================================//
	...
	public Engineer loginEngineer(String EngUserName, String EngPass) throws EngineerException {
     ...
     Engineer engineer=null;
		...
		PreparedStatement ps =conn.prepareStatement("select * from Engineer where engUserName=? AND EngPass=?");
		...
		engineer=new Engineer(id,n,e,p, c);	
			...
			throw new EngineerException("Invalid Username or password, please check once.. ");
		}
	} catch (SQLException e) {
	...
	public String assigningProblemToEngineer(int pid, int engId) throws EngineerException, ProblemException {
		    ...
		    if(rs.next()) {
		    	...
		    	if(rs2.next()) {
		    		...
		    		PreparedStatement ps3=conn.prepareStatement("insert into emp_engg values(?,?) ");
		    	    ...
		    	    if(x>0) 
		    	    	...
		    	    	throw new EngineerException("some things went wrong.....");
...
//	===============================================================================================//
	...
	public List<EngineerDTO> getAlEnginnerAssignProblem( String pname) throws ProblemException {
		...
		if(dtos.isEmpty()) {
			throw new ProblemException("there is not engineer assign to any problem");
		}	
		return dtos;
	}
//	===============================================================================================//
	...
	public String deleteEngineer(String name) throws EngineerException {
       ...
       String message = "Unable to found Engineer";
		...
		try(Connection conn = DButil.provideConnection()) {
			...
			int x = ps.executeUpdate();
			if(x>0) {
				message = (name+" engineer is deleted from system");
			}
		} catch (Exception e) {	
		}
		return message;
...
//=================================================================================================//
	...
	public String changePassword(String username, String password, String newpassword) throws EngineerException {
		...
		PreparedStatement ps= conn.prepareStatement("update Engineer set EngPass= ? where EngUserName= ? AND EngPass= ? ");			
